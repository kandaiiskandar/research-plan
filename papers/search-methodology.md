...
The table below shows the publisher/database breakdown of the 58 included papers, reflecting the range of sources indexed within Scopus and accessed directly.
